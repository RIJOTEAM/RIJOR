...
io.popen("cd library && wget https://raw.githubusercontent.com/RIJOTEAM/RIJOR/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/RIJOTEAM/Files_Rijor/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevRIJORW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevRIJORW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevRIJORW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevRIJORW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRIJORW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRIJORW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevRIJORW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
RIJOR_Msg = 'متفاعل قوي' 
elseif msgs < 2000 then 
RIJOR_Msg = 'متفاعل جدا' 
elseif msgs < 3500 then 
RIJOR_Msg = 'اقوى تفاعل'  
elseif msgs < 4000 then 
RIJOR_Msg = 'متفاعل نار' 
elseif msgs < 4500 then 
RIJOR_Msg = 'قمة التفاعل'
elseif msgs < 5500 then 
RIJOR_Msg = 'اقوى متفاعل' 
elseif msgs < 7000 then 
RIJOR_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
RIJOR_Msg = 'امبروطور التفاعل' 
elseif msgs < 10000000000 then 
RIJOR_Msg = 'اسطورة المتفاعلين'  
end 
return RIJOR_Msg 
end
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@DEVRIJOR")  
...
--------------------------------------------------------------------------------------------------------------
function SourceRIJOR(msg,data) -- بداية العمل الزعيم اليماني
if msg then
...
local list = database:smembers(bot_id.."RIJOR1:List:Filter"..sl)
...
if not DevRIJORW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevRIJORW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,RIJOR_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ⌯' and DevRIJORW(msg) then  
...
if text == 'تعطيل التواصل ⌯' and DevRIJORW(msg) then  
...
if text == 'تفعيل البوت الخدمي ⌯' and DevRIJORW(msg) then  
...
if text == 'تعطيل البوت الخدمي ⌯' and DevRIJORW(msg) then  
...
if text == 'ضع كليشه ستارت ⌯' and DevRIJORW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *⌯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ⌯' and DevRIJORW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ⌯' and DevRIJORW(msg) then 
...
if text == 'تحديث السورس ⌯' and DevRIJORW(msg) then 
os.execute('rm -rf RIJOR.lua')
os.execute('wget https://raw.githubusercontent.com/RIJOTEAM/RIJOR/main/RIJOR.lua')
send(msg.chat_id_, msg.id_,' *⌯︙تم تحديث السورس* \n*⌯︙لديك اخر اصدار لسورس ريكور*\n*⌯︙الاصدار » { 2.8v}*')
dofile('RIJOR.lua')  
end
if text == 'الاصدار ⌯' and DevRIJORW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *⌯︙اصدار سورس ريكور* \n*⌯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ⌯' and DevRIJORW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ⌯︙[تحديثات البوت](t.me/RIJOTEAM) \n⌯︙[قناه السورس](t.me/lll_n_lll1)')
end
if text == "ضع اسم للبوت ⌯" and DevRIJORW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ⌯' and DevRIJORW(msg) then 
...
if text == 'المشتركين ⌯' and DevRIJORW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ⌯' and DevRIJORW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *⌯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ⌯") and DevRIJORW(msg) then
...
if text == ("قائمه العام ⌯") and DevRIJORW(msg) then
...
if text == ("قائمه الكتم العام ⌯") and DevRIJORW(msg) then
...
if text=="اذاعه خاص ⌯" and msg.reply_to_message_id_ == 0 and DevRIJORW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ⌯" and msg.reply_to_message_id_ == 0 and DevRIJORW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ⌯" and msg.reply_to_message_id_ == 0 and DevRIJORW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل الان اذاعتك؟* \n*⌯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ⌯" and msg.reply_to_message_id_ == 0  and DevRIJORW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *⌯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ⌯" and msg.reply_to_message_id_ == 0  and DevRIJORW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ⌯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ⌯' and DevRIJORW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ⌯" and DevRIJORW(msg) then
...
if text == "تنظيف الكروبات ⌯" and DevRIJORW(msg) then 
...
send(msg.chat_id_, msg.id_,'*⌯︙عدد الكروبات الان » { '..#group..' }'..RIJORk..''..RIJOR..'*\n*⌯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevRIJORW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevRIJORW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevRIJORW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevRIJORW(msg) then
...
local RIJOR1_Msg = database:get(bot_id.."RIJOR1:Add:Filter:Rp2"..text..msg.chat_id_)   
if RIJOR1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if RIJOR_Msg and not Special(msg) then  
local RIJOR_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if RIJOR_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevRIJORW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevRIJORW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevRIJORW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevRIJORW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ⌯" and DevRIJORW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *⌯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ⌯$") and DevRIJORW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *⌯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ⌯" and DevRIJORW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ⌯" and DevRIJORW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *⌯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ⌯" and DevRIJORW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."RIJOR:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."RIJOR:blocname"..msg.chat_id_)
...
function DEVRIJOR_name(t1,t2)
if t2.id_ then 
name_RIJOR = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_RIJOR then 
names_RIJOR = database:smembers(bot_id.."RIJOR:blocname"..msg.chat_id_) or ""
if names_RIJOR and names_RIJOR[1] then 
for i=1,#names_RIJOR do 
if name_RIJOR:match("(.*)("..names_RIJOR[i]..")(.*)") then 
...
bnnaGet(msg.sender_user_id_, DEVRIJOR_name)
end
...
database:set(bot_id.."RIJOR:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."RIJOR:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."RIJOR:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."RIJOR:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."RIJOR:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_RIJORa_new(RIJOR1,RIJOR2)
if RIJOR2 and RIJOR2.first_name_ then 
if RIJOR2.first_name_:match("(.*)"..database:get(bot_id.."RIJOR:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."RIJOR:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local RIJOR_nnn = database:get(bot_id.."RIJOR:nump"..msg.chat_id_) or 5
local RIJOR_nnn2 = database:get(bot_id.."RIJOR:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(RIJOR_nnn2) == tonumber(RIJOR_nnn) or tonumber(RIJOR_nnn2) > tonumber(RIJOR_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."RIJOR:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "⌯︙عزيزي >>["..RIJOR2.username_.."](https://t.me/"..(RIJOR2.username_ or "lll_n_lll1")..")\n⌯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."RIJOR:teh"..msg.chat_id_).."} بجانب اسمك\n⌯︙عدد المحاولات المتبقيه {"..(tonumber(RIJOR_nnn) - tonumber(RIJOR_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_RIJORa_new)
end
end
...
local RIJORChengName = database:get(bot_id.."RIJOR:Cheng:Name"..data.id_)
if not data.first_name_ then 
if RIJORChengName then 
send(msg.chat_id_, msg.id_, " الاسم الاول احلا ["..RIJORChengName..']')
database:del(bot_id.."RIJOR:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if RIJORChengName ~= data.first_name_ then 
local Text = {
  "كان الاسم الاول حلو ",
...
database:set(bot_id.."RIJOR:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local RIJORChengUserName = database:get(bot_id.."RIJOR:Cheng:UserName"..data.id_)
if not data.username_ then 
if RIJORChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..RIJORChengUserName..']')
database:del(bot_id.."RIJOR:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if RIJORChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."RIJOR:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local RIJORChengPhoto = database:get(bot_id.."RIJOR:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if RIJORChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."RIJOR:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if RIJORChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."RIJOR:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local url,res = https.request('https://vvvzvv.ml/apiRIJOR/Rijor.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'⌯︙شترك في قناة السورس اولآ @RIJOTEAM .')
return false 
end
Text = "ᎦᎾᏌᎡᏟᎬ ᎡＩᏦỎᎡ\n\n[⌯ ᎦᎾᏌᎡᏟᎬ ᎡᏆᏦỎᎡ](http://t.me/RIJOTEAM)\n\n[⌯ ᏆＮＦᎾ ᏚᎾᏌᎡᏟᎬ](http://t.me/lll_n_lll1)\n\n[⌯  ᎡᎬᏦᎾᎡ ᎠᎬᏙ](http://t.me/DEVRIJOR)\n\n[⌯  ᏴᎾᎢ ᎡᏆᏦᎾᎡ](http://t.me/AREEG_bot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '⌯ ᎦᎾᏌᎡᏟᎬ ᎡＩᏦỎᎡ',url="t.me/RIJOTEAM/3"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/RIJOTEAM&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevRIJORW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
------------------------------------------------------------------------ boss
if text == 'تحديث' and DevRIJORW(msg) then
dofile('RIJOR.lua')  
send(msg.chat_id_, msg.id_, ' *⌯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevRIJORW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevRIJORW(msg) then  
function start_function(extra, result, success)
if RIJORSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevRIJORW(msg) then  
...
if RIJORSudoBot(result.id_) then
...
if text and text:match("^حظر عام (%d+)$") and DevRIJORW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if RIJORSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مبرمج السورس او مطور الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevRIJORW(msg) then  
function start_function(extra, result, success)
if RIJORSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مبرمج السورس او مطور الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevRIJORW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevRIJORW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if RIJORSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*⌯︙لا تستطيع (كتم،طرد،حظر،تققيد) مبرمج السورس او مطور الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevRIJORW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevRIJORW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevRIJORW(msg) then  
...
------------------------------------------------------------------------ boss
if text == ("مسح المطورين") and DevRIJORW(msg) then
...
if database:get(bot_id.."DEVRIJOR:admin:Time"..msg.chat_id_) then 
return
send(msg.chat_id_, msg.id_,"انتظر دقيقه من فضلك")
end
database:setex(bot_id..'DEVRIJOR:admin:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
...
if text == 'الملفات' and DevRIJORW(msg) then
...
if DevRIJORW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/RIJOTEAM/Files_Rijor/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevRIJORW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/RIJOTEAM/Files_Rijor/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevRIJORW(msg) then
...
if text == "مسح الملفات" and DevRIJORW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *⌯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevRIJORW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevRIJORW(msg) then  
function start_function(extra, result, success)
...
function Function_RIJOR(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_RIJOR, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_RIJOR, nil)
return false 
end
...
database:set(bot_id.."RIJOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."RIJOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *⌯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."RIJOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."RIJOR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."RIJOR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."RIJOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *⌯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."RIJOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."RIJOR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."RIJOR1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."RIJOR1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *⌯︙ارسل الكلمه الان*")  
database:set(bot_id.."RIJOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."RIJOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."RIJOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RIJOR1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."RIJOR1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."RIJOR1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."RIJOR1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."RIJOR1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."RIJOR1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevRIJORW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *⌯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevRIJORW(msg) then
...
if text == 'تفعيل الاذاعه' and DevRIJORW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevRIJORW(msg) then  
...
if not database:get(bot_id..'DEVRIJOR:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_) then   
...
database:setex(bot_id..'DEVRIJOR:Delete:Time'..msg.chat_id_..':'..msg.sender_user_id_,300,true)
end
end
...
send(msg.chat_id_, msg.id_,'['..RIJOR_Msg[math.random(#RIJOR_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevRIJORW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,RIJOR)
local t = "\n*ツ قائمة الاعضاء* \n*┄─━━━ ᎡᎬ ━━━━─┄*\n"
x = 0
local list = RIJOR.members_
for k, v in pairs(list) do
x = x + 1
...
if RIJORSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevRIJORW(msg) then 
...
if text == ("ردود المطور") and DevRIJORW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ⌯︙قائمة ردود المطور \n*┄─━━━ ᎡᎬ ━━━━─┄*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevRIJORW(msg) then    
send(msg.chat_id_, msg.id_,' *⌯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevRIJORW(msg) then    
...
if text == 'تفعيل المغادره' and DevRIJORW(msg) then   
...
if text == 'تعطيل المغادره' and DevRIJORW(msg) then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n*⌯︙العضو »* ['..data.first_name_..'](t.me/'..(data.username_ or 'RIJOTEAM')..') '
...
-- vardump(data) 
RIJORdx(msg.chat_id_, msg.id_, ' *⌯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*⌯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*⌯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*⌯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevRIJORW(msg) then
...
{{text = 'ᎦᎾᏌᎡᏟᎬ ᎡᏆᏦỎᎡ', url="t.me/RIJOTEAM"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
{{text = 'ᎦᎾᏌᎡᏟᎬ ᎡᏆᏦỎᎡ', url="t.me/RIJOTEAM"}},
{{text = 'مطور السورس', url="t.me/DEVRIJOR"}},
}
...
zh = https.request('https://vvvzvv.ml/amirZhfa/Rijor.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*⌯︙قائمه الزخرفه* \nٴ⌯∫ٴ*┄─━━━ ᎡᎬ ━━━━─┄*ٴ⌯∫○ٴ \n"
i = 0
...
gk = https.request('https://vvvzvv.ml/amirBrg/Rijor.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://vvvzvv.ml/amirOmr/Rijor.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://vvvzvv.ml/amirVois/Rijor.php')
if res == 200 then
...
inline = {
{{text = 'ᏚᎾᏌᎡᏟᎬ ᎡᏆᏦᎾᎡ¹',url='http://t.me/RIJOTEAM'}},
}
...
local Fun = {'مضبح يمغص البطور',' ولد و ورده 💋🙄','يلعب ع البنات 🙄','ولد مخق البنات 😶🙊','ياليل ام الورعنه مخترت الا ذا ','ذا محترم بعد حاله️','اموت عليه 🌝','هو غير ، الحب حقي 🤓❤️','مو افضل ولد صراحه ☹️','لو يوليني الله عليه لدفنه حي','واحد قذر 🙄😒','ماطيقه شمه كور 😂🤷‍♀️','ولد من حق الجنه 🤓'} 
...
function FunBot(extra, result, success) 
local Fun = {'القلب‌ حقي ','احب كلب ولا احبه ',' لٱ وخر ','يولد اخرتها احب هاذا 💔','ماحب نسويه اسف','انتحر ولا احب ذا يع ','هووووف اموت عليه ','ايععععععععع','لو يقولون اموت لخاطره بموت','ويععععع ماحب ذا النسويه','اول ماشوفه تغثيني نفسي','لٱ ماحبه','خلصنا ياخي دايما تختار عيال شف لنا مزه','شسويت بحياتي حتا طلعلي ذا','افبس حبيبي هذا'} 
send(msg.chat_id_,result.id_,''..Fun[math.random(#Fun)]..'') 
end  
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, FunBot, nil)
return false
...
RIJOR = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(RIJOR)
...
--------------------------------------------------------------------------------------------------------------
SourceRIJOR(data.message_,data)
...
------------------------------------------------------------------------
local RIJORAbot = database:get(bot_id.."RIJOR1:Add:Filter:Rp2"..text..result.chat_id_)   
if RIJORAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *⌯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n⌯︙["..RIJORAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local RIJOR1_Msg = database:get(bot_id.."RIJOR1:Add:Filter:Rp2"..text..result.chat_id_)   
if RIJOR1_Msg then
send(msg.chat_id_, msg.id_," ⌯︙"..RIJOR1_Msg)
